...
<body>
	<form id="submitForm" name="submitForm" action="" method="post">
        <input type="hidden" name="page" value="${pageno}" id=""/>
			...
			<div class="">
				<div class="">
					<table class="" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						<tr>
                            <td>姓名：<input type="text" name="userName"  value="${eduUser.userName}"/></td>
						</tr>
                        <tr>
                            <td>密码：<input type="text" name="password"  value="${eduUser.password}" /></td>
                        </tr>
                        <tr>
                            <td> <input type="submit" class="ui_input_btn01" value="提交" onclick="doUpdatePass();" /></td>
                        </tr>
					</table>
				</div>
			</div>
...
<script type="text/javascript">
    function doUpdatePass() {
        $("#submitForm").attr("action","${APP_PATH}/user/doUpdatePass").submit;
    }
