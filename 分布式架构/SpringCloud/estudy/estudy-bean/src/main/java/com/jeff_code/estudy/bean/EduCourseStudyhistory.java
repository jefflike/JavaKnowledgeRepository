...
public class EduCourseStudyhistory {
    ...
    public EduCourseStudyhistory(Integer id, Integer userId, Integer courseId, Integer kpointId, Integer playercount, String courseName, String kpointName, Date updateTime, String databack) {
        this.id = id;
        this.userId = userId;
